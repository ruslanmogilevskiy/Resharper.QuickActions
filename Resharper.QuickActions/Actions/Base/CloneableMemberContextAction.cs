...
{
    public abstract class CloneableMemberContextAction : GenericContextAction
    {
        protected CloneableMemberContextAction(string actionName, ICSharpContextActionDataProvider provider)
